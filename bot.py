...
FAQ_TEXT = (
    "❓ *FAQ*\n\n"
    "Просьба не путать очки общего рейтинга *(pts/MMR — изначально у каждого 3000 MMR)* и *социальные очки* "
    ...
    "2) *Если A намного сильнее B?* — при большой разнице сильный при победе получает меньше MMR, при поражении теряет больше.\n"
